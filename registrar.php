<!doctype html>
 ...
 <form method="post" action="registro.php" class="form-row">
        ...
        <div class="col-lg-6 " >
            ...
            <button type="button" class="btn btn-block active" onclick="direccion_buscador();"><span class=" glyphicon glyphicon-search "></span>   Buscar direccion</button>
            <button type="button" class="btn btn-block active" onclick="buscar()"><span class="glyphicon glyphicon-map-marker"></span>   Geolocalizacion</button>
            <div id="resultado">
            </div>
        </div>
             <div class="col-lg-6" >
...
?>
            <script>
                ...
                function buscar() {
                    ...
                    // }).addTo(map);
                    // L.control.scale().addTo(map);
                    // var marker = L.marker([-34.603518, -58.381613],{draggable: true}).addTo(map);
                    // marker.bindPopup("<b>Hola Mundo!</b><br>Aqui estan nuestras oficinas").openPopup()
                    // var localizaciones = [-34.603518, -58.381613];
                    // var marker = L.marker(localizaciones);
                    // marker.bindPopup('<p>Latitud:'+localizaciones[0]+'</p><p>Longitud:'+l[1]+'</p>');
                    // marker.addTo(map);
